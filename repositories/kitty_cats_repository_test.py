...
from models import Meow, MeowResponse, generate_utc_timestamp
...
def describe_item_service():
    ...
    def describe_get_by_id():
        def test_successfully_call(mock_cosmos_client: ContainerProxy):
            ...
            repository = MeowRepository(mock_cosmos_client)
    ...
    def describe_update():
        ...
        def test_successfully_call(mock_cosmos_client: ContainerProxy):
            mock_item_response = MeowResponse(
                id='ac1df01c-7ece-4a20-ab60-179829dad8f5',
                name='mockName1',
                type='mockType1'
            )
            ...
            repository = MeowRepository(mock_cosmos_client)
            with patch('repositories.MeowRepository.get_by_id') as mock_get_by_id:
